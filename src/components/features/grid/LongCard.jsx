    ...
    <div className="col-span-2 h-fit sm:h-[209px] ">
      <Card>
        <div className="relative z-20">
          <CalloutChip>Experience</CalloutChip>
          <p className="mb-1.5 text-2xl font-semibold">Trusted by the Best, Backed by Excellence</p>
          <p className="max-w-sm text-white">
          I have worked with top brands and professionals, ensuring quality, reliability, and impact in every project.
          </p>
        </div>
